...
## Plot 1: Histogram of Global_active_power (in Kilowatts)
## Global_active_power: household global minute-avg active power (in kilowatt)
## ---------------------------------------------------------------------------

png(filename = "C:/Users/Larry/Documents/Coursera/ExData_Plotting1/plot1.png", 
                width = 480, height = 480)

  ## create plot
  with(tpower2, hist(Global_active_power, 
                     main = "Global Active Power",
                     col = "red",
                     xlab = "Global Active Power (in kilowatts)"))
  par(oma = c(0,0,1,0))  ## default outer margin is no margin i.e. (0,0,0,0)
  title(main = "Plot 1", outer = TRUE, adj = 0)  #add left aligned title

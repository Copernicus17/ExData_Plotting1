...
## Plot 2: Global_active_power (in Kilowatts) vs. Datetime
## Global_active_power: household global minute-avg active power (in kilowatt)
## ---------------------------------------------------------------------------

png(filename = "C:/Users/Larry/Documents/Coursera/ExData_Plotting1/plot2.png", 
  ...
  title(main = "Plot 2", outer = TRUE, adj = 0)  #add left aligned title
